...
import 'package:agabiamokdsa/shared/components/constants.dart';
...
class PrayDayCubit extends Cubit<PrayDayStates> {
  ...
  List<HomeModel> homeData = [
    HomeModel(
        ...
        startPrayModel: bakerStartPrayList,
      mzamarPrayModel: mzmarPrayList,
      biblePrayModel:biblePrayList ,
      endPrayModel:endPrayList
    ...
    HomeModel(
     ...
     startPrayModel: thirdStartPrayList,
        mzamarPrayModel: mzmar3PrayList,
        biblePrayModel:bible3PrayList ,
        endPrayModel:end3PrayList
    ),

    HomeModel(
        image: 'assets/images/six.jpg',
        title: 'الساعة السادسة',
        startPrayModel: sixStartPrayList,
        mzamarPrayModel: mzmar6PrayList,
        biblePrayModel:bible6PrayList ,
        endPrayModel:end6PrayList,
    ...
    HomeModel(
        ...
        startPrayModel: nineStartPrayList,
        mzamarPrayModel: mzmar9PrayList,
        biblePrayModel:bible9PrayList ,
        endPrayModel:end9PrayList,
    ...
    HomeModel(
        ...
        title: 'الغروب',
        startPrayModel: gerobStartPrayList,
        mzamarPrayModel: mzmargerobPrayList,
        biblePrayModel:biblegerobPrayList ,
        endPrayModel:endgerobPrayList,
    ...
    HomeModel(
        ...
        startPrayModel: gerobStartPrayList,
        mzamarPrayModel: mzmarSleepPrayList,
        biblePrayModel:bibleSleepPrayList ,
        endPrayModel:endSleepPrayList,
