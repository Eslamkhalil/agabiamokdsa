...
class MzmarPray extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Center(
                  child: Text(
                    PrayDayCubit.get(context).model.mzamarPrayModel[0].start??"",
                    textDirection: TextDirection.rtl,
              ...
              ListView.separated(
                  ...
                  itemBuilder: (context, index) => buildPrayArticle(
                      model: PrayDayCubit.get(context)
                          .model
                          .mzamarPrayModel[index]),
                  separatorBuilder: (context, index) => SizedBox(
                    height: 24.0,
                  ),
                  itemCount:
                  PrayDayCubit.get(context).model.mzamarPrayModel.length),
            ],
          ),
        );
      },
